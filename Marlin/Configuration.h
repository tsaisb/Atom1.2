...
#define CUSTOM_MENDEL_NAME "Atom"
...
#define DEFAULT_DELTA_DIAGONAL_ROD 228.82 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 196.85 // mm //158
...
#define Z_PROBE_RETRACT_START_LOCATION {0, 50, 0, 0}  // X, Y, Z, E start location for z-probe retract sequence
...
#define DEFAULT_MAX_ACCELERATION      {4500,4500,4500,9000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
